...
public class FacilityController {
	...
	public ResponseEntity<Object> getFacility() {
		return new ResponseEntity<Object>(service.getFacility(), HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> deleteFacility(@PathVariable Long id) {
		try {
			...
			return new ResponseEntity<Object>("Successfully deleted Facility with id: " + id, HttpStatus.OK);
		} catch (Exception e) {
			return new ResponseEntity<Object>(e.getMessage(), HttpStatus.NOT_FOUND);
		}
	}
