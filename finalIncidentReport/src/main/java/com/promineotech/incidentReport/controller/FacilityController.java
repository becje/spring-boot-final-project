...
public class FacilityController {
	...
	public ResponseEntity<Object> createEmployee(@RequestBody Set<Long> employeeIds, @PathVariable Long id){
		try {
			return new ResponseEntity<Object>(service.updateEmpFacility(employeeIds, id), HttpStatus.CREATED);
		} catch (Exception e) {
